...
DISCLAIMER:  DO NOT! Try to change your /etc/hosts file to use a static IP after this method if you are using Jetson headless.  There must have been some issue with this, and I was not able to access via ssh with Static IP OR DHCP.  Had to completely restart the flashing process.
